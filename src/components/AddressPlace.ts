...
export default class AddressPlace {
    ...
    toHTMLString() {
        ...
        html += "<button id=" + Constants.ADDRESS_PLACE_PICK_BUTTON + " type=\"button\" class=\"btn btn-primary\">Fill in the form</button> <br/>";
        html += "<button id=" + Constants.ADDRESS_PLACE_CLOSE_BUTTON + " type=\"button\" class=\"btn btn-secondary\">Close</button>";
